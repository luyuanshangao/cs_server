 ...
 * @LastEditors: sueRimn
 * @LastEditTime: 2020-04-13 12:50:29
 */

return [
    'title' => "APi接口文档",  //文档title
    'version' => '1.0.0', //文档版本
    'copyright' => 'Powered By cs', //版权信息
    ...
    'public_param' => [
        ...
        ['name' => 'token', 'type' => '字符串', 'require' => 0, 'default' => '', 'other' => '', 'desc' => 'token'],
        ['name' => 'uuid', 'type' => '字符串', 'require' => 0, 'default' => '', 'other' => '', 'desc' => 'uuid'],
    ],
];
